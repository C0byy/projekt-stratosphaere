...
console.log(boxes);
let but4 = new questionbutton("Der Nationale Wetterdienst in Lincon lässt zweimal täglich einen Wetterballon steigen... Aber was wohin fliegt dieser eigentlich?", 92, 5, background, "black");
